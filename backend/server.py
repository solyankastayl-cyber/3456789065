...
async def health():
    ...
    return {
        "ok": True,
        "mode": "TA_ENGINE_CAPITAL_ALLOCATION",
        "version": "21.3.0",
        "phase": "PHASE 21.3 - Capital Allocation Layer",
...
async def root():
    """Root endpoint"""
    return {
        "name": "TA Engine - Meta Portfolio Integration Complete",
        "version": "18.4.0",
        "phase": "PHASE 18.4 - Meta Portfolio Integration",
        "status": "running",
        "endpoints": {
            "health": "/api/health",
            "trading_product": "/api/trading-product/{symbol}",
            "alpha_interaction": "/api/v1/alpha-interaction/*",
            "feature_governance": "/api/v1/research-control/feature-governance/*",
            "factor_governance": "/api/v1/research-control/factor-governance/*",
            "deployment_governance": "/api/v1/research-control/deployment-governance/*",
            "attribution": "/api/v1/research-control/attribution/*",
            "portfolio_intelligence": "/api/v1/portfolio-intelligence/*",
            "portfolio_constraints": "/api/v1/portfolio-constraints/*",
            "meta_portfolio": "/api/v1/meta-portfolio/*",
        }
    }
