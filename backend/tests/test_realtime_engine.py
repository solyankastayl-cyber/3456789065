...
Base URL: https://market-signals-201.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://market-signals-201.preview.emergentagent.com').rstrip('/')
